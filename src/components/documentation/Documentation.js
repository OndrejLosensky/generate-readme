    ...
    return(
        <div className=" flex flex-col items-center">
            ...
            <div className="pt-4">
                ...
                <p data-aos="fade-right" data-aos-delay="1500"> <span className="text-left text-6xl font-black font-dancingScript pt-1"> 4 </span> vložte do vašeho README.md a obnovte stránku</p>
            </div>
        </div>
    )
}
